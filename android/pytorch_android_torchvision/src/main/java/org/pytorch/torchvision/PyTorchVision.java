...
public class PyTorchVision {
  ...
  public static void imageYUV420CenterCropToFloatBuffer1(
      final Image image,
      int rotateCWDegrees,
  ...
  public static void imageYUV420CenterCropToFloatBuffer2(
      final Image image,
      int rotateCWDegrees,
      final int tensorWidth,
      final int tensorHeight,
  ...
  private static native void nativeImageYUV420CenterCropToFloatBuffer1(
      ByteBuffer yBuffer,
      int yRowStride,
      int yPixelStride,
      ByteBuffer uBuffer,
  ...
  private static native void nativeImageYUV420CenterCropToFloatBuffer2(
      ByteBuffer yBuffer,
      int yRowStride,
      int yPixelStride,
      ByteBuffer uBuffer,
